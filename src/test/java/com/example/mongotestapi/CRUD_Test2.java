...
/**
 * 编写测试类，测试基于MongoTemplate 开发的增删改查**/
@SpringBootTest
...
//        name like test
    ...
    public void  updateUser(){
        //根据id查询
        User user = mongoTemplate.findById("64005377f21a127304855939", User.class);
        //修改值
    ...
    public void deleteUser(){
        Query query = new Query(Criteria.where("name").is("test_02"));
